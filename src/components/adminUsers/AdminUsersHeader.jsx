...
export default function AdminUsersHeader({ onInvite }) {
  return (
    <div className="flex flex-wrap items-center justify-between gap-4">
      ...
      <button onClick={onInvite} className="flex items-center gap-2 rounded-lg bg-blue-600 px-4 py-2 text-sm font-semibold text-white hover:bg-blue-700 transition-colors shadow-sm">
